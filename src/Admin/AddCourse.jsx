    ...
    <div className="bg-gray-900 rounded-xl p-4 md:p-6 grid grid-cols-1 md:grid-cols-2 gap-6">
      ...
      <div className="flex flex-col gap-4">
        ...
        <textarea
          ...
          className="w-full p-3 rounded-lg bg-transparent border border-white/30 text-white placeholder-white/50 min-h-[120px] focus:border-purple-500 focus:ring-1 focus:ring-purple-500 outline-none resize-none"
