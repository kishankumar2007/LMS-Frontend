      ...
      <div className="max-w-7xl mx-auto px-4">
            ...
            <div className="relative" ref={profileRef}>
              ...
              {isProfileOpen && (
                <div className="absolute right-0 mt-2 w-40 bg-neutral-800 border border-neutral-700 rounded-lg shadow-lg">
                  ...
                  <button className="w-full text-left px-4 py-2 text-red-400 hover:bg-neutral-700">
                    Sign Out
                  </button>
                </div>
              )}
        ...
        {isMenuOpen && (
          <div className="lg:hidden border-t border-neutral-700 py-3 space-y-2">
            ...
            <button className="block w-full text-left px-3 py-2 text-red-400 hover:bg-neutral-800 rounded-lg">
              Sign Out
            </button>
          </div>
        )}
